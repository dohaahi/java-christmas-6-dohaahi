...
class WeekdayPromotionTest {
    ...
    void Order_Weekday_Discount_Menu() {
        ...
        // when
        int discountAmount1 = weekdayPromotion.discountAmount(menuItems1, date);
        int discountAmount2 = weekdayPromotion.discountAmount(menuItems2, date);
        int discountAmount3 = weekdayPromotion.discountAmount(menuItems3, date);
